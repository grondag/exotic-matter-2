...
public class MachineControlState implements IReadWriteNBT, IMessagePlus {
    public static enum ControlMode {
        ON(false), OFF(false), ON_WITH_REDSTONE(true), OFF_WITH_REDSTONE(true);
    ...
    public static enum RenderLevel {
        NONE, MINIMAL, EXTENDED_WHEN_LOOKING, EXTENDED_WHEN_VISIBLE;
    }

    /**
     * Not all machines use all states, nor are all transitions the same, but wanted
     * a shared vocabulary.
     */
    public static enum MachineState {
        /**
         * Machine is not doing anything, because it is off, not powered, has no work,
         * or is just designed to sit there. This is the default state.
         */
        IDLE,

        /**
         * The machine is thinking about fixing to get ready to get started on doing
         * something... maybe. Might also be searching for work.
         */
        THINKING,

        /**
         * The machine is pulling resources into internal buffers. This state may not be
         * reported much, because usually happens simultaneously with something more
         * interesting.
         */
        SUPPLYING,
        ...
        // Reserved to pad enum serializer so don't break world saves if later add more
        // substances.
        RESERVED01, RESERVED02, RESERVED03, RESERVED04, RESERVED05, RESERVED06, RESERVED07, RESERVED08, RESERVED09, RESERVED10, RESERVED11, RESERVED12,
        RESERVED13, RESERVED14, RESERVED15, RESERVED16, RESERVED17, RESERVED18, RESERVED19, RESERVED20, RESERVED21, RESERVED22, RESERVED23, RESERVED24,
    ...
    public ControlMode getControlMode() {
        return PACKED_CONTROL_MODE.getValue(this);
    }

    public void setControlMode(ControlMode value) {
        PACKED_CONTROL_MODE.setValue(value, this);
    }

    public RenderLevel getRenderLevel() {
        return PACKED_RENDER_LEVEL.getValue(this);
    }

    public void setRenderLevel(RenderLevel value) {
        PACKED_RENDER_LEVEL.setValue(value, this);
    }

    /**
     * If true, then modelState should be populated. Used by block fabricators
     */
    public boolean hasModelState() {
        return PACKED_HAS_MODELSTATE.getValue(this);
    }

    private void updateModelStateStatus() {
        PACKED_HAS_MODELSTATE.setValue(this.modelState != null, this);
    }
    ...
    public boolean hasRecipe() {
        return PACKED_HAS_RECIPE.getValue(this);
    }

    private void updateRecipeStatus() {
        PACKED_HAS_RECIPE.setValue(this.currentRecipe != null, this);
    }
    ...
    public boolean hasTargetPos() {
        return PACKED_HAS_TARGET_POS.getValue(this);
    }

    private void updateTargetPosStatus() {
        PACKED_HAS_TARGET_POS.setValue(this.targetPos != null, this);
    }
    ...
    /**
     * Intended for block fabricators, but usage determined by machine. While values
     * are always non-null, they are not always valid. Check that a modelState or
     * other related attribute also exists
     */
    public BlockSubstance getSubstance() {
        return BlockSubstance.get(PACKED_SUBSTANCE.getValue(this));
    }

    public void setSubstance(BlockSubstance value) {
        PACKED_SUBSTANCE.setValue(value.ordinal, this);
    }

    /** intended for block fabricators, but usage determined by machine. */
    public int getLightValue() {
        return PACKED_LIGHT_VALUE.getValue(this);
    }

    public void setLightValue(int value) {
        PACKED_LIGHT_VALUE.setValue(value, this);
    }

    /** intended for block fabricators, but usage determined by machine. */
    public int getMeta() {
        return PACKED_META.getValue(this);
    }

    public void setMeta(int value) {
        PACKED_META.setValue(value, this);
    }

    public MachineState getMachineState() {
        return PACKED_MACHINE_STATAE.getValue(this);
    }

    public void setMachineState(MachineState value) {
        PACKED_MACHINE_STATAE.setValue(value, this);
    }

    public boolean hasJobTicks() {
        return PACKED_HAS_JOB_TICKS.getValue(this);
    }
    ...
    public short getJobDurationTicks() {
        return this.jobDurationTicks;
    }

    /**
     * This will NOT set JobRemainingTicks to the same value. Use
     * {@link #startJobTicks(short)} for that.
     */
    ...
    /**
     * reduces remaining job ticks by given amount and returns true if job is
     * complete
     */
    ...
    public short getJobRemainingTicks() {
        return this.jobRemainingTicks;
    }
    ...
    public boolean hasMaterialBuffer() {
        return PACKED_HAS_MATERIAL_BUFFER.getValue(this);
    }

    public void hasMaterialBuffer(boolean hasBuffer) {
        PACKED_HAS_MATERIAL_BUFFER.setValue(hasBuffer, this);
    }

    public boolean hasPowerSupply() {
        return PACKED_HAS_POWER_SUPPLY.getValue(this);
    }

    public void hasPowerSupply(boolean hasProvider) {
        PACKED_HAS_POWER_SUPPLY.setValue(hasProvider, this);
    }
