...
public class MachinePower {
    ...
    /**
     * s What portion of battery component volume is actually dedicated to storage
    ...
    /**
     * Efficiency of PE conversion plates when paired with thermoelectic generation
     * plates to capture waste heat.
     */
    public static final float POLYETHYLENE_BOOSTED_CONVERSION_EFFICIENCY = POLYETHYLENE_CONVERSION_EFFICIENCY
            + (1 - POLYETHYLENE_CONVERSION_EFFICIENCY) * THERMOELECTRIC_CONVERSION_EFFICIENCY;

    /**
     * Efficiency of catalytic formation process turning atmospheric CO2 and Water
     * into PE and O2.
     */
    public static final float POLYETHYLENE_FORMATION_EFFICIENCY = 0.90f;

    /**
     * Max rate of PE consumption and conversion to electricity by catalytic
     * conversion plate in linear microometers per simulated second. Volume will be
     * surface area of plate x this number. This number is pure hand-waving because
    ...
    /**
     * Max possible sum of World.getSunBrightnessFactor() for a single minecraft
     * day. Used to allocate daily insolation per-tick based on current brightness
     */
    ...
    /**
     * Minimum insolation (0-1) that applies at sea level on a sunny day in icy
     * biome.
     */
    public static final float DAILY_INSOLATION_MIN_FACTOR = (float) 7200000 / DAILY_INSOLATION_MAX_JOULES;

    /**
     * How much daily insolation can normally vary. Is 1 -
     * {@link #DAILY_INSOLATION_MIN_FACTOR}.
     */
    public static final float DAILY_INSOLATION_VARIABILITY = 1 - DAILY_INSOLATION_MIN_FACTOR;

    /**
     * Returns factor of {@link #DAILY_INSOLATION_MAX_JOULES} that will be received
     * during maximum world brightness for the given location.
     * <p>
     * 
     * Factors influencing include: sky light - if none always zero rainfall - can
     * it happen and how much? temp - higher = better height - higher is slightly
     * better
     */
    public static float insolationFactor(Location location) {
        ...
        float rainFactor = b.canRain() ? (1 - MathHelper.clamp(b.getRainfall(), 0, 1)) * 0.8f : 1;

        float variation = tempFactor * 0.6f + rainFactor * 0.3f + location.getY() / 255f * 0.1f;

        return DAILY_INSOLATION_MIN_FACTOR + DAILY_INSOLATION_VARIABILITY * variation;
    }

    /**
     * How much of insolation is captured by photo-electric cells as electrical
     * energy.
     */
    public static final float PHOTO_ELECTRIC_EFFICIENCY = 0.65f;

    /**
     * How much of insolation is captured by photo-chemical cells as chemical
     * energy.
     */
     ...
     * to reflect fact that CO2 capture may use active concentration mechanism. Cost
     * should not be charged if device has access to concentrated CO2.
     */
...
//    }
    ...
    /**
     * Here to remind me that I can't just multiply joules (watt seconds) by 20 to
     * watts, because 20 ticks is a real-world second, not a simulated second. Doing
     * so will understate power consumption.
     */
    ...
    private static final Function<?, ?> FORMAT_JOULES[] = {
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "kJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "kJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "MJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "MJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "GJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "GJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "TJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "TJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "PJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "PJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "EJ");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "EJ");
                }
            },
    ...
    private static final Function<?, ?> FORMAT_WATTS[] = {
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "kW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "kW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "MW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "MW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "GW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "GW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "TW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "TW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "PW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "PW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal1_2Suffix(t, "EW");
                }
            },
            ...
            new Function<String, String>() {
                @Override
                public String apply(String t) {
                    return insertDecimal2_1Suffix(t, "EW");
                }
            },
