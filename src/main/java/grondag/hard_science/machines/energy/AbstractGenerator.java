...
public abstract class AbstractGenerator implements IEnergyComponent {
    ...
    /**
     * Implementation can assume maxOutput has already been tested/adjusted against
     * per-tick max. Machine is the machine containing the power component - in case
     * it needs access to other machine components.
     */
