...
public class BufferManager implements IReadWriteNBT, IItemHandler, IDeviceComponent, ISimulationTickable {
    ...
    public BufferManager(IDevice owner, long itemInputSize, IResourcePredicate<StorageTypeStack> itemInputPredicate, long itemOutputSize, long fluidInputSize,
            IResourcePredicate<StorageTypeFluid> fluidInputPredicate, long fluidOutputSize) {
        this.owner = owner;
    ...
    public void onConnect() {
        ...
        if (this.itemInput != null)
            this.itemInput.onConnect();
        if (this.itemOutput != null)
            this.itemOutput.onConnect();
        if (this.fluidInput != null)
            this.fluidInput.onConnect();
        if (this.fluidOutput != null)
            this.fluidOutput.onConnect();
    }
    ...
    public void onDisconnect() {
        ...
        if (this.itemInput != null)
            this.itemInput.onDisconnect();
        if (this.itemOutput != null)
            this.itemOutput.onDisconnect();
        if (this.fluidInput != null)
            this.fluidInput.onDisconnect();
        if (this.fluidOutput != null)
            this.fluidOutput.onDisconnect();
    }
