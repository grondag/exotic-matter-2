...
public class SuperBlockMaterialCalculator {
    ...
    public SuperBlockMaterialCalculator(ISuperModelState modelState, BlockSubstance requestedSubstance, int lightValue) {
        ...
        if (requestedSubstance == ModSubstances.DURAWOOD || requestedSubstance == ModSubstances.FLEXWOOD || requestedSubstance == ModSubstances.HYPERWOOD) {
        ...
        } else if (requestedSubstance == ModSubstances.DURAGLASS || requestedSubstance == ModSubstances.FLEXIGLASS
        ...
        // We assume the shape is a cube for this purpose - some shapes could have
