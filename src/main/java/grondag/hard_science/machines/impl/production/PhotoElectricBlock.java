...
public class PhotoElectricBlock extends MachineSimpleBlock
{
    ...
    private static ISuperModelState createDefaulModelState()
    {
        ...
        result.setTexture(PaintLayer.BASE, grondag.exotic_matter.init.ModTextures.BLOCK_NOISE_SUBTLE_ZOOM);
        ...
        result.setTexture(PaintLayer.LAMP, grondag.exotic_matter.init.ModTextures.BLOCK_NOISE_SUBTLE);
