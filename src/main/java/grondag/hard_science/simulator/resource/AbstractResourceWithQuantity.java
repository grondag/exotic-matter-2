...
public abstract class AbstractResourceWithQuantity<V extends StorageType<V>> implements ITypedStorage<V>, IResourcePredicateWithQuantity<V> {
    ...
    /**
     * Increases quantityStored and returns quantityStored actually added. Intended
     * to be thread-safe.
     */
