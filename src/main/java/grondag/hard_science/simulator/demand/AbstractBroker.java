...
public class AbstractBroker<V extends StorageType<V>> implements IBroker<V> {
    ...
    /**
     * Called by request if new demands are added, perhaps because WIP was
     * cancelled. Signals broker to wake up any producers that have given up on
     * existing demands.
     * <p>
     * 
     * {@inheritDoc}
    ...
    /**
     * Called by request if priority changes but should still be tracked by this
     * broker.
     * <p>
     * 
     * {@inheritDoc}
