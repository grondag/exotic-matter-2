...
//}
    ...
    public static void drawTexturedRectWithColor(double xCoord, double yCoord, double zLevel, Sprite textureSprite, double widthIn, double heightIn, int color,
            TextureScale scale, Rotation rotation, boolean useAlpha) {
        ...
        vertexbuffer.vertex((double) (xCoord + 0), (double) (yCoord + heightIn), zLevel).texture(uv[0][0], uv[1][0]).color(red, green, blue, alpha).end();
        vertexbuffer.vertex((double) (xCoord + widthIn), (double) (yCoord + heightIn), zLevel).texture(uv[0][1], uv[1][1]).color(red, green, blue, alpha).end();
        vertexbuffer.vertex((double) (xCoord + widthIn), (double) (yCoord + 0), zLevel).texture(uv[0][2], uv[1][2]).color(red, green, blue, alpha).end();
        vertexbuffer.vertex((double) (xCoord + 0), (double) (yCoord + 0), zLevel).texture(uv[0][3], uv[1][3]).color(red, green, blue, alpha).end();
        tessellator.draw();
...
//            RenderHelper.enableStandardItemLighting();
     ...
     * string, x, y, color
     */
    public static void drawAlignedStringNoShadow(FontRenderer fontRendererIn, String text, float x, float y, float width, float height, int color,
    ...
    public static void drawAlignedStringNoShadow(FontRenderer fontRendererIn, String text, double x, double y, double width, double height, int color,
            HorizontalAlignment hAlign, VerticalAlignment vAlign) {
