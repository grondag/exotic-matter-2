...
/**
 * TODO: Rewrite to handle alpha in each paint layer now. Then remove
 * translucency enum.
 */
...
public class TranslucencyPicker extends GuiControl<TranslucencyPicker> {
    ...
    protected void drawContent(IGuiRenderContext renderContext, int mouseX, int mouseY, float partialTicks) {
        GuiUtil.drawAlignedStringNoShadow(renderContext.fontRenderer(), LABEL, (float) this.left, (float) this.top, (float) (this.width - this.firstBoxLeft),
                (float) this.height, TEXT_COLOR_LABEL, HorizontalAlignment.LEFT, VerticalAlignment.MIDDLE);
