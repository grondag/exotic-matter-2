...
public interface XmBlock {
     ...
     * 
     */
    ModelState getModelState(BlockView world, BlockPos pos, boolean refreshFromWorldIfNeeded);

    /**
     * Use when absolutely certain given block state is current.
     */
    ModelState getModelStateAssumeStateIsCurrent(BlockState state, BlockView world, BlockPos pos,
     ...
     */
    ModelState computeModelState(BlockState state, BlockView world, BlockPos pos,
            boolean refreshFromWorldIfNeeded);
