...
public class XmBlockRegistryImpl {
    ...
    public static void register(Block block, Function<BlockState, ImmutableModelState> defaultStateFunc,
	...
	private XmBlockStateImpl(ImmutableModelState defaultModelState, WorldToModelStateFunction worldStateFunc,
