...
public class VirtualBlockEntity extends XmBlockEntity
{
    ...
    public void fromTag(CompoundTag compound)
    {
        ...
        this.domainID = compound.containsKey(NBT_DOMAIN_ID) 
                ? compound.getInt(NBT_DOMAIN_ID) 
                : IIdentified.UNASSIGNED_ID;
                
        this.buildID = compound.containsKey(NBT_BUILD_ID) 
                ? compound.getInt(NBT_BUILD_ID) 
                : IIdentified.UNASSIGNED_ID;          
    }
