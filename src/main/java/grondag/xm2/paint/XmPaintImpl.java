...
import static grondag.xm2.api.paint.XmPaint.MAX_TEXTURE_DEPTH;
...
public class XmPaintImpl {
	...
	if (obj != null && obj instanceof XmPaintImpl) {
	    ...
	    return paintBits == other.paintBits && color0 == other.color0 && color1 == other.color1
		    && color2 == other.color2 && vertexProcessor0 == other.vertexProcessor0
		    && vertexProcessor1 == other.vertexProcessor1 && vertexProcessor2 == other.vertexProcessor2;
	} else {
	    return false;
	}
    }
