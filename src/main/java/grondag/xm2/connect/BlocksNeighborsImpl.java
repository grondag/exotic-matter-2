...
public class BlocksNeighborsImpl implements BlockNeighbors, BlockTestContext {
    ...
    public static BlocksNeighborsImpl claim(BlockView world, int x, int y, int z, ModelStateFunction stateFunc,
	    BlockTest blockTest) {
    ...
    BlocksNeighborsImpl prepare(BlockView world, int x, int y, int z, ModelStateFunction stateFunc,
	    BlockTest blockTest) {
	this.world = world;
	this.x = x;
	this.y = y;
