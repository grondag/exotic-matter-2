...
import static grondag.xm2.primitives.stream.EncoderFunctions.BAD_ADDRESS;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_FLOAT;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_FLOAT_FAIL;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_HALF_INT_HIGH;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_HALF_INT_LOW;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_INT;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_INT_FAIL;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_INT_WHITE;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_NORMAL_X_QUANTIZED;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_NORMAL_Y_QUANTIZED;
import static grondag.xm2.primitives.stream.EncoderFunctions.GET_NORMAL_Z_QUANTIZED;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_FLOAT;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_FLOAT3;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_FLOAT3_FAIL;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_FLOAT_FAIL;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_HALF_INT_HIGH;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_HALF_INT_LOW;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_INT;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_INT_FAIL;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_INT_WHITE;
import static grondag.xm2.primitives.stream.EncoderFunctions.SET_NORMAL_XYZ_QUANTIZED;
import static grondag.xm2.primitives.stream.PolyStreamFormat.FACE_NORMAL_FORMAT_COMPUTED;
import static grondag.xm2.primitives.stream.PolyStreamFormat.FACE_NORMAL_FORMAT_NOMINAL;
import static grondag.xm2.primitives.stream.PolyStreamFormat.FACE_NORMAL_FORMAT_QUANTIZED;
import static grondag.xm2.primitives.stream.PolyStreamFormat.POLY_FORMAT_COUNT;
import static grondag.xm2.primitives.stream.PolyStreamFormat.POLY_FORMAT_SHIFT;
import static grondag.xm2.primitives.stream.PolyStreamFormat.VERTEX_COLOR_PER_VERTEX_LAYER;
import static grondag.xm2.primitives.stream.PolyStreamFormat.VERTEX_COLOR_SAME;
import static grondag.xm2.primitives.stream.PolyStreamFormat.VERTEX_COLOR_SAME_BY_LAYER;
import static grondag.xm2.primitives.stream.PolyStreamFormat.VERTEX_COLOR_WHITE;
import static grondag.xm2.primitives.stream.PolyStreamFormat.getFaceNormalFormat;
import static grondag.xm2.primitives.stream.PolyStreamFormat.getLayerCount;
import static grondag.xm2.primitives.stream.PolyStreamFormat.getVertexColorFormat;
import static grondag.xm2.primitives.stream.PolyStreamFormat.isLinked;
import static grondag.xm2.primitives.stream.PolyStreamFormat.isTagged;
import static grondag.xm2.primitives.stream.PolyStreamFormat.polyFormatKey;
...
import grondag.xm2.primitives.stream.EncoderFunctions.FloatGetter;
import grondag.xm2.primitives.stream.EncoderFunctions.FloatSetter;
import grondag.xm2.primitives.stream.EncoderFunctions.FloatSetter3;
import grondag.xm2.primitives.stream.EncoderFunctions.IntGetter;
import grondag.xm2.primitives.stream.EncoderFunctions.IntSetter;
