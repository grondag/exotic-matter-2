...
public class CsgPolyStream extends MutablePolyStream {
    ...
    private static final int vertexIncrement(float x, float y, float z, float normalX, float normalY, float normalZ,
            float dist) {
    ...
    private static final int vertexType(float x, float y, float z, float normalX, float normalY, float normalZ,
            float dist) {
        final float t = x * normalX + y * normalY + z * normalZ - dist;
    ...
    private static void clipPolyInner(IntArrayList stack, CsgPolyStream targetStream,
            final CsgPolyStream clippingStream, final int polyAddress, int nodeAddress) {
