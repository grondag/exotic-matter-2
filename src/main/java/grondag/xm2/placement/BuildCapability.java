...
public class BuildCapability implements IUserCapability {
    ...
    /**
     * Retrieves active build in given dimension if exists, creates new build in
     * this domain and makes it the active build for the player otherwise.
     */
    ...
    /**
     * Makes given build the active build in its dimension. Note that if the given
     * build is not open, will be re-assigned to a new build on retrieval.
     */
