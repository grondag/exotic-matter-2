...
import static grondag.xm2.placement.PlacementPreviewRenderMode.PLACE;
import static grondag.xm2.placement.PlacementPreviewRenderMode.SELECT;
...
//    }
    ...
    protected boolean doValidate()
    {
        ...
        else if(this.isExcavation)
        {
            ...
            Pair<Direction, Direction> nearestCorner 
    ...
    protected void drawPlacement(Tessellator tessellator, BufferBuilder bufferBuilder, PlacementPreviewRenderMode previewMode)
    {
        ...
        if(!visible.intersects(box)) return;
        ...
        if(entity != null)
        {
            ...
            RenderUtil.drawGrid(
                    bufferBuilder, 
                    box, 
                    entity.getCameraPosVec(XmRenderHelper.tickDelta()),
