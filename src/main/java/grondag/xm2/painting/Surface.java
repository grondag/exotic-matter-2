...
public class Surface {
    public final static class Builder {
        ...
        /**
         * Convenient when only one or two layers are enabled. Note the new list
         * <em>replaces</em> the existing list of disabled layers.
         */
        ...
        public final Surface build() {
            return new Surface(topology, uvWrapDistance, ignoreDepthForRandomization, allowBorders, isLampGradient,
        ...
        public final float uvWrapDistance() {
            return this.uvWrapDistance;
        }

        public final boolean ignoreDepthForRandomization() {
            return this.ignoreDepthForRandomization;
        }
        ...
        public final boolean isLampGradient() {
            return this.isLampGradient;
        }

        public final int layerDisabledFlags() {
            return this.layerDisabledFlags;
        }
    }
    ...
    /**
     * If true, texture painting should not vary by axis orthogonal to the surface.
     * Ignored if {@link #textureSalt} is non-zero.
     */
    public final boolean ignoreDepthForRandomization;

    /**
     * If false, border and masonry painters will not render on this surface. Set
     * false for topologies that don't play well with borders.
     */
    public final boolean allowBorders;

    /**
     * If true, generator will assign colors to vertexes to indicate proximity to
    ...
    private Surface(SurfaceTopology topology, float uvWrapDistance, boolean ignoreDepthForRandomization,
            boolean allowBorders, boolean isLampGradient, int layerDisabledFlags) {
        this.topology = topology;
