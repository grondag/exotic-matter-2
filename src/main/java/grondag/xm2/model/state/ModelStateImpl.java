...
public class ModelStateImpl implements ModelState {
	...
	if (obj instanceof ModelStateImpl) {
	    ...
	    return this.isStatic == other.isStatic && this.coreBits == other.coreBits
		    ...
		    && this.layerBitsOuter == other.layerBitsOuter && this.paints[0] == other.paints[0]
		    && this.paints[1] == other.paints[1] && this.paints[2] == other.paints[2]
		    && this.paints[3] == other.paints[3] && this.paints[4] == other.paints[4]
