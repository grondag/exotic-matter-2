...
public class ModShapes
{
    ...
    public static final ModelShape<?> TERRAIN_HEIGHT = ModelShapes.create("terrain_height", TerrainMeshFactory.class, SHAPE, true);
    public static final ModelShape<?> TERRAIN_FILLER = ModelShapes.create("terrain_filler", TerrainMeshFactory.class, SHAPE, false);
