...
public enum SimpleJoinFaceState
{
    ...
    RIGHT(FaceSide.RIGHT.bitFlag),
    TOP_BOTTOM(FaceSide.TOP.bitFlag | FaceSide.BOTTOM.bitFlag),
    ...
    TOP_LEFT(FaceSide.TOP.bitFlag | FaceSide.LEFT.bitFlag),
    TOP_RIGHT(FaceSide.TOP.bitFlag | FaceSide.RIGHT.bitFlag),
    ...
    public static SimpleJoinFaceState find(EnumFacing face, SimpleJoin join)
    {
        int faceFlags = 0;
