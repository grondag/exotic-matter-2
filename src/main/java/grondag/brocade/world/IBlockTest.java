...
public interface IBlockTest {
    ...
    public default boolean testBlock(Direction face, ISuperBlockAccess world, BlockState ibs, BlockPos pos,
            ISuperModelState modelState) {
        return testBlock(face, world, ibs, pos);
    }

    public default boolean testBlock(BlockCorner corner, ISuperBlockAccess world, BlockState ibs, BlockPos pos,
            ISuperModelState modelState) {
        return testBlock(corner, world, ibs, pos);
    }

    public default boolean testBlock(FarCorner corner, ISuperBlockAccess world, BlockState ibs, BlockPos pos,
            ISuperModelState modelState) {
        return testBlock(corner, world, ibs, pos);
    }
