...
public class CollisionBoxStore {
    private static final IntSimpleLoadingCache<AxisAlignedBB> boxCache = new IntSimpleLoadingCache<AxisAlignedBB>(
            new BoxLoader(), 0xFFF);
    ...
    static final IBoxBoundsObjectFunction<AxisAlignedBB> boxMaker = (minX, minY, minZ, maxX, maxY, maxZ) -> {
        return new AxisAlignedBB(minX / 8f, minY / 8f, minZ / 8f, maxX / 8f, maxY / 8f, maxZ / 8f);
    };
