 ...
 * 
 * When API is available, quads with a solid base layer can always render entirely in the
 * solid block layer. When it isn't available, they will also need to render in translucent.<p>
 * 
...
public abstract class RenderLayoutProducer
{
    ...
    public static final RenderLayoutProducer[] VALUES = {ALWAYS_SOLID, ALWAYS_BOTH, ALWAYS_TRANSLUCENT, ALWAYS_NONE, DEPENDS}; 
