...
public class CachedBakedQuad extends BakedQuad {
    ...
    public CachedBakedQuad(int[] vertexDataIn, int tint, @Nullable EnumFacing faceIn, TextureAtlasSprite spriteIn,
    ...
    public boolean equals(@Nullable Object other) {
        if (other instanceof CachedBakedQuad) {
            ...
            return this.format == otherQuad.format && this.sprite == otherQuad.sprite && this.face == otherQuad.face
