...
public class LitBakedQuad extends BakedQuad {
    ...
    private static class Wrapper {
        ...
        public final void wrap(IVertexConsumer lighter, LitBakedQuad quad)
    ...
    public void interpolateVertexColors(int vertexIndex, float[] colors) {
        ...
        if (glow == 15) {
            ...
            // This is brittle, but easy and fast, and right now that is only format
            // supported for pre-lit quads.
    ...
    /**
     * Returns value 0-15 representing how emmissive the vertex is. 0 means normal
     * lighting, normal shading for diffuse and AO. 15 means full lighting, no
     * shading or coloring for diffuse or AO
     */
    ...
    public boolean equals(Object other) {
        if (other instanceof LitBakedQuad) {
            ...
            if (!(this.format == otherQuad.format && this.sprite == otherQuad.sprite && this.face == otherQuad.face
