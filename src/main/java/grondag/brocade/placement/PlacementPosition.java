...
public class PlacementPosition
{
     ...
     * @param isExcavation if true will select *in* starting block vs *on* it
     */
    public PlacementPosition(EntityPlayer player, @Nullable BlockPos onPos, @Nullable EnumFacing onFace, @Nullable Vec3d hitVec, int floatingSelectionRange, boolean isExcavation)
    {
