...
public class Polygon2x3 extends AbstractPolygonNx3<Polygon2x3>
{
    @SuppressWarnings("unchecked")
    private static final Layer<Polygon2x3>[] LAYERS = new Layer[2];
    
    static
    {
        LAYERS[0] = new Layer<Polygon2x3>()
        {
            {
    ...
    @SuppressWarnings("unchecked")
    private static final VertexLayer<Polygon2x3>[][] VERTEX_LAYERS = new VertexLayer[2][4];
    
    static
    {
        VERTEX_LAYERS[0][0] = new VertexLayer<Polygon2x3>()
        {
            {
        ...
        VERTEX_LAYERS[0][1] = new VertexLayer<Polygon2x3>()
        {
            {
        ...
        VERTEX_LAYERS[0][2] = new VertexLayer<Polygon2x3>()
        {
            {
        ...
        VERTEX_LAYERS[1][0] = new VertexLayer<Polygon2x3>()
        {
            {
        ...
        VERTEX_LAYERS[1][1] = new VertexLayer<Polygon2x3>()
        {
            {
        ...
        VERTEX_LAYERS[1][2] = new VertexLayer<Polygon2x3>()
        {
            {
    ...
    @Override
    protected final VertexLayer<Polygon2x3>[][] layerVertexArray()
    {
        return VERTEX_LAYERS;
    }

    @Override
    protected final Layer<Polygon2x3>[] layerAccess()
    {
        return LAYERS;
    }
