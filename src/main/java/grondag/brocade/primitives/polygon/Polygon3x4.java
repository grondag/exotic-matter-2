...
public class Polygon3x4 extends AbstractPolygonNx4<Polygon3x4>
{
    @SuppressWarnings("unchecked")
    private static final Layer<Polygon3x4>[] LAYERS = new Layer[3];
    
    static
    {
        LAYERS[0] = new Layer<Polygon3x4>()
        {
            {
    ...
    @SuppressWarnings("unchecked")
    private static final VertexLayer<Polygon3x4>[][] VERTEX_LAYERS = new VertexLayer[3][4];
    
    static
    {
        VERTEX_LAYERS[0][0] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[0][1] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[0][2] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[0][3] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[1][0] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[1][1] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[1][2] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[1][3] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[2][0] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[2][1] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[2][2] = new VertexLayer<Polygon3x4>()
        {
            {
        ...
        VERTEX_LAYERS[2][3] = new VertexLayer<Polygon3x4>()
        {
            {
                this.colorGetter = v -> v.color2_3;
                this.colorSetter = (v, color) -> v.color2_3 = color;
                
                this.uGetter = v -> v.u2_3;
                this.uSetter = (v, u) -> v.u2_3 = u;
                
                this.vGetter = v -> v.v2_3;
                this.vSetter = (v, vVal) -> v.v2_3 = vVal;
    ...
    private float u2_3;
    private float v2_3;
    private int color2_3 = 0xFFFFFFFF;
    ...
    @Override
    protected final VertexLayer<Polygon3x4>[][] layerVertexArray()
    {
        return VERTEX_LAYERS;
    }

    @Override
    protected final Layer<Polygon3x4>[] layerAccess()
    {
        return LAYERS;
    }
