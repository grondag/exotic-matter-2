...
/**
 * Implementations of IPolyStream that declare this interface
 * guarantee that no polygon in the stream will be mutated.<p>
 * 
 * If present means IMutablePolyStream is NOT implemented
