...
import static grondag.exotic_matter.model.primitives.stream.EncoderFunctions.GET_HALF_INT_HIGH;
import static grondag.exotic_matter.model.primitives.stream.EncoderFunctions.GET_HALF_INT_LOW;
...
import static grondag.exotic_matter.model.primitives.stream.EncoderFunctions.GET_INT_WHITE;
...
import static grondag.exotic_matter.model.primitives.stream.EncoderFunctions.SET_HALF_INT_HIGH;
...
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.POLY_FORMAT_SHIFT;
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.VERTEX_COLOR_PER_VERTEX_LAYER;
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.VERTEX_COLOR_SAME;
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.VERTEX_COLOR_SAME_BY_LAYER;
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.VERTEX_COLOR_WHITE;
...
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.isTagged;
import static grondag.exotic_matter.model.primitives.stream.PolyStreamFormat.polyFormatKey;
