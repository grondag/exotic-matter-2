...
import static grondag.brocade.primitives.stream.EncoderFunctions.BAD_ADDRESS;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_FLOAT;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_FLOAT_FAIL;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_HALF_INT_HIGH;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_HALF_INT_LOW;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_INT;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_INT_FAIL;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_INT_WHITE;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_NORMAL_X_QUANTIZED;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_NORMAL_Y_QUANTIZED;
import static grondag.brocade.primitives.stream.EncoderFunctions.GET_NORMAL_Z_QUANTIZED;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_FLOAT;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_FLOAT3;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_FLOAT3_FAIL;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_FLOAT_FAIL;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_HALF_INT_HIGH;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_HALF_INT_LOW;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_INT;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_INT_FAIL;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_INT_WHITE;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_NORMAL_XYZ_QUANTIZED;
import static grondag.brocade.primitives.stream.PolyStreamFormat.FACE_NORMAL_FORMAT_COMPUTED;
import static grondag.brocade.primitives.stream.PolyStreamFormat.FACE_NORMAL_FORMAT_NOMINAL;
import static grondag.brocade.primitives.stream.PolyStreamFormat.FACE_NORMAL_FORMAT_QUANTIZED;
import static grondag.brocade.primitives.stream.PolyStreamFormat.POLY_FORMAT_COUNT;
import static grondag.brocade.primitives.stream.PolyStreamFormat.POLY_FORMAT_SHIFT;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_COLOR_PER_VERTEX_LAYER;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_COLOR_SAME;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_COLOR_SAME_BY_LAYER;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_COLOR_WHITE;
import static grondag.brocade.primitives.stream.PolyStreamFormat.getFaceNormalFormat;
import static grondag.brocade.primitives.stream.PolyStreamFormat.getLayerCount;
import static grondag.brocade.primitives.stream.PolyStreamFormat.getVertexColorFormat;
import static grondag.brocade.primitives.stream.PolyStreamFormat.isLinked;
import static grondag.brocade.primitives.stream.PolyStreamFormat.isTagged;
import static grondag.brocade.primitives.stream.PolyStreamFormat.polyFormatKey;

import grondag.brocade.primitives.polygon.IPolygon;
import grondag.brocade.primitives.stream.EncoderFunctions.FloatGetter;
import grondag.brocade.primitives.stream.EncoderFunctions.FloatSetter;
import grondag.brocade.primitives.stream.EncoderFunctions.FloatSetter3;
import grondag.brocade.primitives.stream.EncoderFunctions.IntGetter;
import grondag.brocade.primitives.stream.EncoderFunctions.IntSetter;
