...
/**
 * Polygons in this stream can be edited after appending via
 * an editor cursor.  To allow for editing, polygons in this
 * type of stream consume more memory.<p>
 * 
 * The number of layers can be changed after appending, but
 * number of vertices cannot.
 */
public interface IMutablePolyStream extends IWritablePolyStream
{
    ...
    /**
     * True if moves editor to next non-deleted poly.
     * False if at the end of the stream.
     */
    boolean editorNext();
