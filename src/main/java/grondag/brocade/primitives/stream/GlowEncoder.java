...
import static grondag.brocade.primitives.stream.PolyStreamFormat.*;
...
public abstract class GlowEncoder {
    ...
    public static GlowEncoder get(int format) {
        ...
        return glowFormat == VERTEX_GLOW_PER_VERTEX || isMutable(format) ? VERTEX_GLOW
                : glowFormat == VERTEX_GLOW_SAME ? SAME_GLOW : NO_GLOW;
    }
