...
public abstract class EncoderFunctions
{
    ...
    public static final ByteGetter GET_BYTE_FAIL = (stream, address, byteIndex) -> {throw new UnsupportedOperationException();};
    ...
    public static final ByteSetter SET_BYTE_FAIL = (stream, address, byteIndex, value) -> {throw new UnsupportedOperationException();};
    
    public static final IntGetter GET_INT_FAIL = (stream, address) -> {throw new UnsupportedOperationException();};
    ...
    public static final IntSetter SET_INT_FAIL = (stream, address, value) -> {throw new UnsupportedOperationException();};
    public static final IntSetter SET_INT = (stream, address, value) -> stream.set(address, value);
    
    public static final IntSetter SET_HALF_INT_LOW = (stream, address, value) 
            -> stream.set(address, (stream.get(address) & 0xFFFF0000) | (value & 0xFFFF));
    public static final IntSetter SET_HALF_INT_HIGH = (stream, address, value) 
            -> stream.set(address, (stream.get(address) & 0x0000FFFF) | (value << 16));
    
    public static final FloatGetter GET_FLOAT_FAIL = (stream, address) -> {throw new UnsupportedOperationException();};
    public static final FloatGetter GET_FLOAT = (stream, address) -> Float.intBitsToFloat(stream.get(address));
    
    public static final FloatSetter SET_FLOAT_FAIL = (stream, address, value) -> {throw new UnsupportedOperationException();};
    public static final FloatSetter SET_FLOAT = (stream, address, value) -> stream.set(address, Float.floatToRawIntBits(value));
    
    public static final FloatSetter2 SET_FLOAT2_FAIL = (stream, address, u, v) -> {throw new UnsupportedOperationException();};
    ...
    public static final FloatSetter3 SET_FLOAT3_FAIL = (stream, address, x, y, z) -> {throw new UnsupportedOperationException();};
