...
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_FLOAT2;
import static grondag.brocade.primitives.stream.EncoderFunctions.SET_FLOAT2_FAIL;
...
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_FORMAT_COUNT;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_FORMAT_SHIFT;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_NORMAL_FACE;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_NORMAL_QUANTIZED;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_NORMAL_REGULAR;
import static grondag.brocade.primitives.stream.PolyStreamFormat.VERTEX_UV_BY_LAYER;
...
import static grondag.brocade.primitives.stream.PolyStreamFormat.getVertexNormalFormat;
import static grondag.brocade.primitives.stream.PolyStreamFormat.isMutable;
import static grondag.brocade.primitives.stream.PolyStreamFormat.setLayerCount;
import static grondag.brocade.primitives.stream.PolyStreamFormat.setQuantizedPos;
import static grondag.brocade.primitives.stream.PolyStreamFormat.setVertexColorFormat;
import static grondag.brocade.primitives.stream.PolyStreamFormat.setVertexNormalFormat;
import static grondag.brocade.primitives.stream.PolyStreamFormat.setVertexUVFormat;
import static grondag.brocade.primitives.stream.PolyStreamFormat.vertexFormatKey;
...
import grondag.brocade.primitives.stream.EncoderFunctions.FloatSetter2;
