...
class VoxelVolumeKey {
    ...
    public VoxelVolumeKey toImmutable() {
        ...
        VoxelVolumeKey result = new VoxelVolumeKey();
        System.arraycopy(this.voxelBits, 0, result.voxelBits, 0, 8);
...
//        final long start = System.nanoTime();
        ...
        if (!isEmpty()) {
            if (isFull()) {
                ...
                int halves = 0;
                if(count000 == 64) halves |= 0b00000001;
                if(count001 == 64) halves |= 0b00000010;
                if(count010 == 64) halves |= 0b00000100;
                if(count011 == 64) halves |= 0b00001000;
                if(count100 == 64) halves |= 0b00010000;
                if(count101 == 64) halves |= 0b00100000;
                if(count110 == 64) halves |= 0b01000000;
                if(count111 == 64) halves |= 0b10000000;
