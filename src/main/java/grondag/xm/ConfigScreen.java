...
public class ConfigScreen {
    static Screen getScreen(Screen parent) {
        ...
        ConfigBuilder builder = ConfigBuilder.create().setParentScreen(parent).setTitle("config.xm.title").setSavingRunnable(ConfigScreen::saveUserInput);

        // DEBUG
        ConfigCategory blocks = builder.getOrCreateCategory("config.xm.category.debug");
