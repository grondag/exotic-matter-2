...
public class WritablePolyStreamImpl extends AbstractPolyStream implements WritablePolyStream {
    ...
    @Override
    public ReadOnlyPolyStream releaseAndConvertToReader(int formatFlags) {
        ReadOnlyPolyStream result = PolyStreams.claimReadOnly(this, formatFlags);
        release();
        return result;
    }
