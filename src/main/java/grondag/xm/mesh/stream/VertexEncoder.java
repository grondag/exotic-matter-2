...
import static grondag.xm.mesh.stream.EncoderFunctions.SET_FLOAT2;
import static grondag.xm.mesh.stream.EncoderFunctions.SET_FLOAT2_FAIL;
...
import static grondag.xm.mesh.stream.PolyStreamFormat.VERTEX_FORMAT_COUNT;
import static grondag.xm.mesh.stream.PolyStreamFormat.VERTEX_FORMAT_SHIFT;
import static grondag.xm.mesh.stream.PolyStreamFormat.VERTEX_NORMAL_FACE;
import static grondag.xm.mesh.stream.PolyStreamFormat.VERTEX_NORMAL_QUANTIZED;
import static grondag.xm.mesh.stream.PolyStreamFormat.VERTEX_NORMAL_REGULAR;
import static grondag.xm.mesh.stream.PolyStreamFormat.VERTEX_UV_BY_LAYER;
...
import static grondag.xm.mesh.stream.PolyStreamFormat.getVertexNormalFormat;
import static grondag.xm.mesh.stream.PolyStreamFormat.isMutable;
import static grondag.xm.mesh.stream.PolyStreamFormat.setLayerCount;
import static grondag.xm.mesh.stream.PolyStreamFormat.setQuantizedPos;
import static grondag.xm.mesh.stream.PolyStreamFormat.setVertexColorFormat;
import static grondag.xm.mesh.stream.PolyStreamFormat.setVertexNormalFormat;
import static grondag.xm.mesh.stream.PolyStreamFormat.setVertexUVFormat;
