...
public class MutablePolyStreamImpl extends WritablePolyStreamImpl implements MutablePolyStream {
    ...
    protected void appendCopy(Polygon polyIn, int withFormat) {
        ...
        int newFormat = PolyStreamFormat.setLayerCount(withFormat, polyIn.spriteDepth());
