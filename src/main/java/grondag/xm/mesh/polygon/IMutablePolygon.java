...
import grondag.xm.mesh.polygon.IMutablePolygon.Helper.UVLocker;
import grondag.xm.mesh.vertex.IMutableVertex;
...
public interface IMutablePolygon extends IPolygon {
    ...
    default IMutablePolygon setVertex(int vertexIndex, float x, float y, float z, float u, float v, int color, float normX, float normY, float normZ) {
        return this.setVertex(vertexIndex, normX, normY, normZ, u, v, color).normal(vertexIndex, normX, normY, normZ);
    }
